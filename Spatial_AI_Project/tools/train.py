...
# mmdet3d???¬ì „???„ìš” (CUDA ?˜ì¡´???†ì´ ?¬ìš© ê°€?¥í•œ ë¶€ë¶„ë§Œ)
try:
    ...
    # mmdet3dê°€ ?†ëŠ” ê²½ìš°ë¥??„í•œ fallback
...
def main():
    ...
    if hasattr(cfg, 'plugin'):
        if cfg.plugin:
            ...
            from Ref_AI_project.mmdet3d_plugin.bevformer.apis.train import custom_train_model
    # set cudnn_benchmark
