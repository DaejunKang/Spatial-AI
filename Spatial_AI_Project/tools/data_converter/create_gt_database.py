...
# roi_align?Ä torchvision.ops?êÏÑú ?¨Ïö© Í∞Ä??try:
    from torchvision.ops import roi_align as roi_align
except ImportError:
    # fallback: Í∞ÑÎã®??Íµ¨ÌòÑ ?êÎäî ?êÎü¨ Ï≤òÎ¶¨
...
def create_groundtruth_database(dataset_class_name,
    ...
    Args:
        dataset_class_name Ôºàstr): Name of the input dataset.
